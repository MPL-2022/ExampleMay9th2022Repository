...
public class Assign6 {
	...
	private static void createProject()
	{
		try
		{
			...
			oBrowser.findElement(By.xpath("//*[text()='Create Project']")).click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();
	...
	private static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea\r\n")).sendKeys("This is the project description");
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[1]/div[1]")).sendKeys("This is the project description");
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();
